...
import com.citi.retail.optima.etl.batch.job.processor.EventAggregationProcessor;
...
public class EventAggregationProcessorTest {
	@Mock
	private AggregationSqlRuleLookup aggregationSqlLookup;
	@Mock
	private AggregationRulesLookup aggregationRulesLookup;
	private EventAggregationProcessor<SupplementaryDataRecord> aggregationProcessor;
	...
	public void setUp() throws Exception {/*
		aggregationProcessor = new EventAggregationProcessor();
		aggregationServiceFactory = new AggregationServiceFactoryImpl();
		aggregationServiceFactory.setAggregationRulesLookup(aggregationRulesLookup);
		...
		Mockito.when(this.aggregationRulesLookup.getAggregationRules(Mockito.anyList())).thenReturn(list);
