package com.citi.retail.optima.batch.core.step;
 ...
 * Implements {@link BeanNameAware} so that
 * if no name is provided explicitly it will be inferred from the bean
 * definition in Spring configuration.
 * 
 */
public class StepSupport implements Step, BeanNameAware {
	 ...
	 * the callbacks in a Spring container the
	 * name property will be set first if it is present. Care is needed with
	 * bean definition inheritance - if a parent
