...
public class FileIntegrityException extends Exception implements Serializable {
	...
	public FileIntegrityException(String exceptionMessage) {
		super();
		this.exceptionMessage = exceptionMessage;
	}
	
	public FileIntegrityException(String exceptionMessage, String rootException) {
		super();
		this.exceptionMessage = exceptionMessage;
		this.rootException = rootException;		
	}
	
	public FileIntegrityException( String exceptionMessage, String rootException, Exception e) {
		super();
		this.exceptionMessage = exceptionMessage;
		this.rootException = rootException;
