 ...
 *         Enrichment Retail Evaluation Context to register custom functions and
 ...
 */
public class EnrichmentCustomEvaluationContext extends
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(EnrichmentCustomEvaluationContext.class);
	...
	public void init() throws NoSuchMethodException {
		...
		LOGGER.debug("EnrichmentCustomEvaluationContext Initialisation Begin");
		setBeanResolver(new BeanFactoryResolver(this.appContext));		
		LOGGER.debug("EnrichmentCustomEvaluationContext Initialisation End");
	}

	/**
	 * Registers the <code>java.lang.reflect.Method</code> reference of the
	 * custom methods created in enrichment retail in the current evaluation
	...
	public void setCustomEvaluationProvider(CustomEvaluationProvider<Map<String, Method>> customEvaluationProvider) {
