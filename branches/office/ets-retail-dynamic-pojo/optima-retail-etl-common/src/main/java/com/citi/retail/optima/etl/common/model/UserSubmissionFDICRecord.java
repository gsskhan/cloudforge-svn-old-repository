...
public class UserSubmissionFDICRecord extends UserSubmissionBaseRecord {
	...
	public String toString() {
		return "UserSubmissionFDICRecord [creditBureau=" + creditBureau
				+ ", modelVersion=" + modelVersion + ", modelScore="
				+ modelScore + ", excludedAmt=" + excludedAmt + ", fxRate="
				+ fxRate + ", localCurrCode=" + localCurrCode
				+ ", submitterId=" + submitterId + ", contactId=" + contactId
				+ ", refId=" + refId + ", dataVersion=" + dataVersion
				+ ", eFedPdPercent=" + eFedPdPercent + ", eFedEffEnrAmt="
				+ eFedEffEnrAmt + ", eFedEnrGtTrshld=" + eFedEnrGtTrshld
				+ ", eFedTotalExcludedAmt=" + eFedTotalExcludedAmt
				+ ", eFedScoredAmt=" + eFedScoredAmt + ", eFedUnscoredAmt="
				+ eFedUnscoredAmt + ", eFedSpecialScoredAmt="
				+ eFedSpecialScoredAmt + ", eFedIncludeScoredAmt="
				+ eFedIncludeScoredAmt + ", eFedTotalEffEnrAmt="
				+ eFedTotalEffEnrAmt + ", eFedTotalEnrAmt=" + eFedTotalEnrAmt
				+ ", eFedPrivHighRiskEnrAmt=" + eFedPrivHighRiskEnrAmt
				+ ", eFedFinalHighRiskEnrAmt=" + eFedFinalHighRiskEnrAmt
				+ ", eFedAmountEnrPDBand="
				+ Arrays.toString(eFedAmountEnrPDBand) + ", pdThreshold="
				+ pdThreshold + "]";
	}
