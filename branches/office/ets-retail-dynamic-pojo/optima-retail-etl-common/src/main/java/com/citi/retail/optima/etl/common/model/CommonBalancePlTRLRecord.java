...
public class CommonBalancePlTRLRecord extends ExcludableRecord{
	...
	public void setEPenaltyAmnt(Long ePenaltyAmnt) {
		this.ePenaltyAmnt = ePenaltyAmnt;
	}
	/**
	 ...
	 */
	public Long geteArrngNextPymtDueToBankAmnt() {
	...
	public void setEArrngNextPymtDueToBankAmnt(Long eArrngNextPymtDueToBankAmnt) {
		this.eArrngNextPymtDueToBankAmnt = eArrngNextPymtDueToBankAmnt;
	}
	/**
	 ...
	 */
	public Long getAcctLastPymtToBankAmount() {
	...
	public void setEAcctLastPymtToBankAmount(Long eAcctLastPymtToBankAmount) {
		this.eAcctLastPymtToBankAmount = eAcctLastPymtToBankAmount;
	}
	/**
	...
	public void setETotalPymnts(Long eTotalPymnts) {
		this.eTotalPymnts = eTotalPymnts;
	}
	/**
	 ...
	 */
	public Long geteTotalFundsDisbAmnt() {
	...
	public void setETotalFundsDisbAmnt(Long eTotalFundsDisbAmnt) {
		this.eTotalFundsDisbAmnt = eTotalFundsDisbAmnt;
	}
	/**
...
//	} // Change
	 ...
	 */
	public Long geteEffctRatePercent() {
	...
	public void setEEffctRatePercent(Long eEffctRatePercent) {
		this.eEffctRatePercent = eEffctRatePercent;
	}
	/**
...
//	}
	 ...
	 */
	public String getBankruptcyDt() {
		return bankruptcyDt;
	}
	/**
	 * @param bankruptcyDt the bankruptcyDt to set
	 */
	public void setBankruptcyDt(String bankruptcyDt) {
	 ...
	 */
	public String geteLstWriteDownDt() {
		return eLstWriteDownDt;
	}
	/**
	 * @param lstWriteDownDt the lstWriteDownDt to set
	 */
	public void setELstWriteDownDt(String eLstWriteDownDt) {
...
//	}
	 ...
	 */
	public Long geteAcctLastPymtToBankAmount() {
		return eAcctLastPymtToBankAmount;
	}
	/**
...
//	}
	...
	public CommonBalancePlTRLRecord(){
		super();
	}
	
	
	public CommonBalancePlTRLRecord(LoansTRLRecord record){
		this.eUniqueIdSrcSys= record.geteUniqueIdSrcSys();
				this.eSrcSysId=record.geteSrcSysId();
				this.eRecordType=record.geteRecordType();
				this.legNumber=record.getLegNumber();
				this.eProdSysId=record.geteProdSysId();
				this.eAsOfDate=record.geteAsOfDate();
				this.generalLedgerSysId=record.getGeneralLedgerSysId();
				this.dealId=record.getDealId();
				this.bookingLedgerCC=record.getBookingLedgerCC();
				this.balanceTyp=record.getBalanceTyp();
				this.eGLAccount1=record.geteGLAccount1();
				this.glAcct2=record.getGlAcct2();
				this.fdlAcct=record.getFdlAcct();
				this.eTransCurr=record.geteTransCurr();
				this.eFuncCurrencyCode=record.geteFuncCurrencyCode();
				this.eBaseCurrencyCode=record.geteBaseCurrencyCode();
				//this.eTxnAmt=record.geteTxnAmt();
				//this.eTxnAmt=new BigDecimal(record.geteTxnAmt());
				...
				this.frsBUCode=record.getFrsBUCode();
				this.notForUse=record.getNotForUse();
				this.localDeptId=record.getLocalDeptId();
				this.eLocalLegalVehicleId=record.geteLocalLegalVehicleId();
				this.notForUse=record.getNotForUse();
				this.fairValueAccMethodFlg=record.getFairValueAccMethodFlg();
				this.fairValue=record.getFairValue();
				this.expenseCode=record.getExpenseCode();
				this.eLocalProductCode=record.geteLocalProductCode();
				this.frsAffCode=record.getFrsAffCode();
				this.notForUse=record.getNotForUse();
				this.subStrategyCode=record.getSubStrategyCode();
				this.notForUse=record.getNotForUse();
				this.notForUse=record.getNotForUse();
				this.notForUse=record.getNotForUse();
				this.eGaapIndicator=record.geteGaapIndicator();
				this.microControlStratCode=record.getMicroControlStratCode();
				this.firmAcctIMSNo=record.getFirmAcctIMSNo();
				this.baseNo=record.getBaseNo();
				this.prodId=record.getProdId();
				this.keyCode1=record.getKeyCode1();
				this.keyCode2=record.getKeyCode2();
				this.localLedgerAcctNo=record.getLocalLedgerAcctNo();
				this.adjInd=record.getAdjInd();
				this.userId=record.getUserId();
				this.adjReasonCode=record.getAdjReasonCode();
				this.comment=record.getComment();
				this.localGlKey3=record.getLocalGlKey3();
				this.localGlKey4=record.getLocalGlKey4();
				this.adjStdArrngId=record.getAdjStdArrngId();
	...
	public String toString() {
		return "CommonBalancePlTRLRecord [eFinServiceTypId=" + eFinServiceTypId
				...
				+ eDenominationCurrencyId + ", eArrgBusIntentType="
				+ eArrgBusIntentType + ", ePledgedIndicator="
				+ ePledgedIndicator + ", ePledgedElgibilityIndicator="
				...
				+ ", eBalType=" + eBalType + ", arrangmentName="
				...
				+ ", rateName=" + rateName + ", eRateVariabilityTypId="
				...
				+ reservedforfutureGenesisusage19 + ", eBaseAmt=" + eBaseAmt
				+ "]";
	}
