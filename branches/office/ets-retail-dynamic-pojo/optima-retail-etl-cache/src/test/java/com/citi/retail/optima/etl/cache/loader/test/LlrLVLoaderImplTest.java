...
import com.citi.retail.optima.etl.cache.ehcache.loaders.LlrLVCacheLoaderImpl;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration({ "/optima.retail.cache.referencedata.test.xml",
		"/optima.retail.cache.test.xml" })
public class LlrLVLoaderImplTest {

	@Autowired
	private LlrLVDaoImpl llrLVDao;

	@Autowired
	private LlrLVCacheLoaderImpl llrLVCacheLoader;

	@Test
	public void testReferenceLoader() throws Exception {

		llrLVCacheLoader.afterPropertiesSet();

		ReflectionTestUtils.setField(llrLVCacheLoader, "dao", llrLVDao);
	}
}
