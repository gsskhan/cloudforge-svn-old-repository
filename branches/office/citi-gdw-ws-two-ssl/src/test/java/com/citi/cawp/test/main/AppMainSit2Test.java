...
private static Logger log = Logger.getLogger(AppMainSit2Test.class.getName());
	...
	public static void main(String[] args) {	
		...
		System.setProperty("javax.net.ssl.keyStore","C:/opt/gdwcert/CAWP_Dev2/CAWP_167925_DEV2.p12");
		System.setProperty("javax.net.ssl.keyStorePassword", "CAWP_167925_DEV2");
		System.setProperty("javax.net.ssl.keyStoreType", "PKCS12");
