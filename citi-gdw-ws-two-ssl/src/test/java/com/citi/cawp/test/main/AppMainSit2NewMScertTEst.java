...
public class AppMainSit2NewMScertTEst {
...
private static Logger log = Logger.getLogger(AppMainSit2Test.class.getName());
	...
	public static void main(String[] args) {	
		...
		System.setProperty("javax.net.ssl.keyStore","C:/opt/gdwcert/167925_Dev/167925_Dev.p12");
		System.setProperty("javax.net.ssl.keyStorePassword", "167925_Dev");
		System.setProperty("javax.net.ssl.keyStoreType", "PKCS12");
