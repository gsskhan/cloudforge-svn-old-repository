package com.citi.retail.optima.etl.common.filescanner.util.test;
...
import com.citi.retail.optima.etl.common.filescanner.util.FileUtil;
/**
 * @author av51190
 * 
 */
public class FileUtilTest {
	...
	public void testIsDataTypeMatchingForString() {
		...
		String regex = FileScannerConstants.REGEX_STRING;
	...
	public void testIsDataTypeMatchingForNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_NUMBER;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertFalse(FileUtil.isDataTypeMatching(value, regex));
		value = "-123.12";
	...
	public void testIsDataTypeMatchingForNegativeNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_NEGATIVENUMBER;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123.12";
	...
	public void testIsDataTypeMatchingForDecimalNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_DECIMALNUMBER;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertFalse(FileUtil.isDataTypeMatching(value, regex));
		value = "123.12";
	...
	public void testIsDataTypeMatchingForNegativeDecimalNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_NEGATIVEDECIMALNUMBER;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "123.12";
	...
	public void testIsDataTypeMatchingForNotNullString() {
		String value = "ABCD123_ ";
		String regex = FileScannerConstants.REGEX_STRING_NOTNULL;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "";
		Assert.assertFalse(FileUtil.isDataTypeMatching(value, regex));
		value = null;
	...
	public void testIsDataTypeMatchingForNotNullNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_NUMBER_NOTNULL;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertFalse(FileUtil.isDataTypeMatching(value, regex));
		value = "-123.12";
	...
	public void testIsDataTypeMatchingForNegativeNotNullNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_NEGATIVENUMBER_NOTNULL;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123.12";
	...
	public void testIsDataTypeMatchingForDecimalNotNullNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_DECIMALNUMBER_NOTNULL;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertFalse(FileUtil.isDataTypeMatching(value, regex));
		value = "123.12";
	...
	public void testIsDataTypeMatchingForNegativeDecimalNotNullNumber() {
		String value = "123";
		String regex = FileScannerConstants.REGEX_NEGATIVEDECIMALNUMBER_NOTNULL;
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "-123";
		Assert.assertTrue(FileUtil.isDataTypeMatching(value, regex));
		value = "123.12";
