...
public class UserSubmissionCCARRecord extends UserSubmissionBaseRecord {
	...
	public String toString() {
		return "UserSubmissionCCARRecord [collateralizedFlag="
				+ collateralizedFlag + ", gcbcPortfolioId=" + gcbcPortfolioId
				+ ", currLineLoanSize=" + currLineLoanSize + ", originalLtv="
				+ originalLtv + ", age=" + age + ", delqStatus=" + delqStatus
				+ ", origFico=" + origFico + ", vintage=" + vintage
				+ ", numAccounts=" + numAccounts + ", unpaidPrinBalAmt="
				+ unpaidPrinBalAmt + ", outstandingDpdOver30Amt="
				+ outstandingDpdOver30Amt + ", numAcctDpdOver30="
				+ numAcctDpdOver30 + ", accountEver30DpdLast12Amt="
				+ accountEver30DpdLast12Amt + ", accountEver60DpdLast12Amt="
				+ accountEver60DpdLast12Amt + ", numNewAccounts="
				+ numNewAccounts + ", newAccountAmt=" + newAccountAmt
				+ ", commitmentAmt=" + commitmentAmt + ", newCommitmentAmt="
				+ newCommitmentAmt + ", commitmentIncrAmt=" + commitmentIncrAmt
				+ ", commitmentDecrAmt=" + commitmentDecrAmt
				+ ", modificationAmt=" + modificationAmt
				+ ", grossContractualChargeOffAmt="
				+ grossContractualChargeOffAmt + ", bankruptcyChargeOffAmt="
				+ bankruptcyChargeOffAmt + ", recovery=" + recovery
				+ ", numAcctChargeOff=" + numAcctChargeOff
				+ ", netChargeOffAmt=" + netChargeOffAmt
				+ ", adjNetChargeOffAmt=" + adjNetChargeOffAmt
				+ ", foreclosureAmt=" + foreclosureAmt + ", newForeclosureAmt="
				+ newForeclosureAmt + ", reoAmt=" + reoAmt + ", newReoAmt="
				+ newReoAmt + ", vehicleTypeCarVanAmt=" + vehicleTypeCarVanAmt
				+ ", vehicleTypeSuvTruckAmt=" + vehicleTypeSuvTruckAmt
				+ ", vehicleTypeSportAmt=" + vehicleTypeSportAmt
				+ ", vehicleTypeUnknown=" + vehicleTypeUnknown + ", repo="
				+ repo + ", currentMonthRepo=" + currentMonthRepo
				+ ", projectedValueLease=" + projectedValueLease
				+ ", ActSaleProceedsLease=" + ActSaleProceedsLease
				+ ", refPortfolioCcy=" + refPortfolioCcy + ", fxRate=" + fxRate
				+ ", rptBasis=" + rptBasis + ", submitterId=" + submitterId
				+ ", contactId=" + contactId + ", dataVersion=" + dataVersion
				+ ", eFedPortfolio=" + eFedPortfolio + ", eBusinessUnit="
				+ eBusinessUnit + ", eFedRegionSegmentId="
				+ eFedRegionSegmentId + ", eFedProductTypeSegmentId="
				+ eFedProductTypeSegmentId + ", eFedOrigLtvSegmentId="
				+ eFedOrigLtvSegmentId + ", eFedAgeSegmentId="
				+ eFedAgeSegmentId + ", eFedDelqSegmentId=" + eFedDelqSegmentId
				+ ", eFedFicoSegmentId=" + eFedFicoSegmentId
				+ ", eFedCollateralizedSegmentId="
				+ eFedCollateralizedSegmentId
				+ ", eFedOutstandingDpdOver30Amt="
				+ eFedOutstandingDpdOver30Amt + ", eFedNumAcctDpdOver30="
				+ eFedNumAcctDpdOver30 + ", eFedAccountEver30DpdLast12Amt="
				+ eFedAccountEver30DpdLast12Amt
				+ ", eFedAccountEver60DpdLast12Amt="
				+ eFedAccountEver60DpdLast12Amt + ", eFedNumNewAccounts="
				+ eFedNumNewAccounts + ", eFedNewAccountAmt="
				+ eFedNewAccountAmt + ", eFedCommitmentAmt="
				+ eFedCommitmentAmt + ", eFedNewCommitmentAmt="
				+ eFedNewCommitmentAmt + ", eFedCommitmentIncrAmt="
				+ eFedCommitmentIncrAmt + ", eFedCommitmentDecAmt="
				+ eFedCommitmentDecAmt + ", eFedModificationAmt="
				+ eFedModificationAmt + ", eFedGrossContractualChargeOffAmt="
				+ eFedGrossContractualChargeOffAmt
				+ ", eFedBankruptcyChargeOffAmt=" + eFedBankruptcyChargeOffAmt
				+ ", eFedRecoveryAmt=" + eFedRecoveryAmt
				+ ", eFedNumAcctChargeOf=" + eFedNumAcctChargeOf
				+ ", eFedNetChargeOffAmt=" + eFedNetChargeOffAmt
				+ ", eFedAdjNetChargeOffAmt=" + eFedAdjNetChargeOffAmt
				+ ", eFedForeclosureAmt=" + eFedForeclosureAmt
				+ ", eFedNewForeclosureAmt=" + eFedNewForeclosureAmt
				+ ", eFedReoAmt=" + eFedReoAmt + ", eFedNewReoAmt="
				+ eFedNewReoAmt + ", eFedVhclTypeCarVanAmt="
				+ eFedVhclTypeCarVanAmt + ", eFedVhclTypeSuvTruckAmt="
				+ eFedVhclTypeSuvTruckAmt + ", eFedVhclTypeSportAmt="
				+ eFedVhclTypeSportAmt + ", eFedVhclTypeUnknownAmt="
				+ eFedVhclTypeUnknownAmt + ", eFedRepoAmt=" + eFedRepoAmt
				+ ", eFedCurrentMonthRepoAmt=" + eFedCurrentMonthRepoAmt
				+ ", eFedProjValueLeaseAmt=" + eFedProjValueLeaseAmt
				+ ", eFedActSaleProceedsLeaseAmt="
				+ eFedActSaleProceedsLeaseAmt + ", eFedNumAccounts="
				+ eFedNumAccounts + ", eFedUnpaidPrinBalAmt="
				+ eFedUnpaidPrinBalAmt + ", eAdjustmentAmt=" + eAdjustmentAmt
				+ ", eCalcNetChargeOffAmt=" + eCalcNetChargeOffAmt
				+ ", ePortfolioDefinition=" + ePortfolioDefinition
				+ ", eExcludePortfolio=" + eExcludePortfolio
				+ ", eFedCurrLineLoanSize=" + eFedCurrLineLoanSize
				+ ", eFedVintage=" + eFedVintage + ", eFedFxRate=" + eFedFxRate
				+ ", eFedRefPortfolioCcy=" + eFedRefPortfolioCcy
				+ ", eFedRefRptBasis=" + eFedRefRptBasis + ", ePearlDlqSeg="
				+ ePearlDlqSeg + ", eGcl=" + eGcl + "]";
	}
