 ...
 *
 */
public class CommonBalanceTRLRecord extends ExcludableRecord{
	/**
	...
	public CommonBalanceTRLRecord(){
		super();		
	}
	
	public CommonBalanceTRLRecord(CardsTRLRecord crdsRecord){
		...
		this.eGLAccount1 = crdsRecord.geteGLAccount1();
		this.eGOC = crdsRecord.geteGOC();
		this.eLocalLegalVehicleId = crdsRecord.geteLocalLegalVehicleId();
		//this.eTxnAmt = new BigDecimal(crdsRecord.geteTxnAmt());//.setScale(10, BigDecimal.ROUND_UNNECESSARY);
		this.eFdlAccount = crdsRecord.geteFdlAccount();
		this.expenseCode = crdsRecord.getExpenseCode();
		this.notForUse=crdsRecord.getNotForUse();
		this.eBaseAmtCurr = crdsRecord.geteBaseAmtCurr();
		this.eBookingLedgerBranchCode = crdsRecord.geteBookingLedgerBranchCode();
		this.eGeneralLedgerSysId = crdsRecord.geteGeneralLedgerSysId();
		this.eFrsBUCode = crdsRecord.geteFrsBUCode();
		this.eDealId = crdsRecord.geteDealId();
		this.eLocalDeptId = crdsRecord.geteLocalDeptId();
		this.eFrsAffiliateCode = crdsRecord.geteFrsAffiliateCode();
	}
	...
	protected BigDecimal eTxnAmt;
	
	protected BigDecimal eBaseAmt;
	...
	public void seteFuncAmt(BigDecimal eFuncAmt) {
		this.eFuncAmt = eFuncAmt;
	}
	...
	public String toString() {
		return "CommonBalanceTRLRecord [eSrcSysId=" + eSrcSysId
				+ ", eProdSysId=" + eProdSysId + ", eRecType=" + eRecType
				+ ", eRatingIssuerId=" + eRatingIssuerId + ", eModelCode="
				+ eModelCode + ", eRatingReasonId=" + eRatingReasonId
				+ ", eRank=" + eRank + ", eEffDate=" + eEffDate + ", eEndDate="
				+ eEndDate + ", eRptMonthDate=" + eRptMonthDate
				+ ", eFicoScore=" + eFicoScore + ", eRatingDesc=" + eRatingDesc
				...
				+ eRelationshipType + ", notForUse=" + notForUse
				+ ", expenseCode=" + expenseCode + ", eBaseAmtCurr="
				+ eBaseAmtCurr + ", lastCashTransactionDt="
