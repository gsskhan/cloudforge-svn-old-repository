...
import com.citi.retail.optima.etl.common.model.HkMtgWrtOffRecord;
 ...
 * 
 */
public class HkMortgageAcctnumbDataProcessor<T> implements ItemProcessor<T, T>,InitializingBean, ItemReadListener<T> {
	...
	private static final Logger LOGGER = LoggerFactory
            ...
            .getLogger(HkMortgageAcctnumbDataProcessor.class);
	
	@Override
	public T process(T currentEvent) throws Exception {
		preProcessdMap.put(((DataAcqMtgBaseRecord)currentEvent).getAcctnumb(), currentEvent);
		return currentEvent;
	}
