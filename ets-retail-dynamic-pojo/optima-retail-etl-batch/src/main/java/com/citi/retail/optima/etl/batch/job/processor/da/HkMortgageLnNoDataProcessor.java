 ...
 * 
 */
public class HkMortgageLnNoDataProcessor<T> implements ItemProcessor<T, T>,InitializingBean, ItemReadListener<T> {
	...
	private static final Logger LOGGER = LoggerFactory
            ...
            .getLogger(HkMortgageLnNoDataProcessor.class);
	
	@Override
	public T process(T currentEvent) throws Exception {
		preProcessdMap.put(((DataAcqMtgBaseRecord)currentEvent).getLnNo(), currentEvent);
		return currentEvent;
	}
