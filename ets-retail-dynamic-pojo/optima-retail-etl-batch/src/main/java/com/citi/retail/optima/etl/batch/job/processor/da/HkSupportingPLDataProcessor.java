 ...
 * 
 */
public class HkSupportingPLDataProcessor<T> implements ItemProcessor<T, T>,InitializingBean, ItemReadListener<T> {
	...
	private static final Logger LOGGER = LoggerFactory
            ...
            .getLogger(HkSupportingPLDataProcessor.class);
	
	@Override
	public T process(T currentEvent) throws Exception {
		preProcessdMap.put(((DataAcqPLBaseRecord)currentEvent).getLnNo(), currentEvent);
		return currentEvent;
	}
