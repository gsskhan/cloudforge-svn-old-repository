...
import com.citi.retail.optima.etl.common.model.DataAcqTwRcBaseRecord;

/**
 * @author sr67841
 * 
 */
public class TwRcCrdAcctNbrDataProcessor<T> implements ItemProcessor<T, T>,InitializingBean, ItemReadListener<T> {
	...
	private static final Logger LOGGER = LoggerFactory
            ...
            .getLogger(TwRcCrdAcctNbrDataProcessor.class);
	@Override
	public T process(T currentEvent) throws Exception {
		preProcessdMap.put(((DataAcqTwRcBaseRecord)currentEvent).getCrdAcctNbr(), currentEvent);
		return currentEvent;
	}
