 ...
 * 
 */
public class TwSupportingDataProcessor<T> implements ItemProcessor<T, T>,InitializingBean, ItemReadListener<T> {
	...
	private static final Logger LOGGER = LoggerFactory
            ...
            .getLogger(TwSupportingDataProcessor.class);
	
	@Override
	public T process(T currentEvent) throws Exception {
		preProcessdMap.put(((DataAcqCardsBaseRecord)currentEvent).getCardNumber(), currentEvent);
		return currentEvent;
	}
