...
public class HkMtgWriteOffConditionalItemWriter extends
		CompositeItemWriter<HkMtgWriteOffTRLRecord> implements StepExecutionListener {

	private ItemWriter<? super HkMtgWriteOffTRLRecord> excludeItemDelegate;

	private Long partitionWriteRecordCount = 0L;

	private StepExecution stepExecution;

	public void write(List<? extends HkMtgWriteOffTRLRecord> item) throws Exception {
		
		List<HkMtgWriteOffTRLRecord> includeList = new ArrayList<HkMtgWriteOffTRLRecord>();

		for (HkMtgWriteOffTRLRecord itemRecord : item) {
			if(itemRecord != null){
	...
	private void saveCBResult(HkMtgWriteOffTRLRecord itemRecord) {
	...
	public void setExcludeItemDelegate(
			ItemWriter<? super HkMtgWriteOffTRLRecord> excludeItemDelegate) {
