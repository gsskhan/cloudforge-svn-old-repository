...
public class HkMtgWoRecvConditionalItemWriter extends
		CompositeItemWriter<HkMtgWoRecvTRLRecord> implements StepExecutionListener {

	private ItemWriter<? super HkMtgWoRecvTRLRecord> excludeItemDelegate;

	private Long partitionWriteRecordCount = 0L;

	private StepExecution stepExecution;

	public void write(List<? extends HkMtgWoRecvTRLRecord> item) throws Exception {
		
		List<HkMtgWoRecvTRLRecord> includeList = new ArrayList<HkMtgWoRecvTRLRecord>();

		for (HkMtgWoRecvTRLRecord itemRecord : item) {
			if(itemRecord != null){
	...
	private void saveCBResult(HkMtgWoRecvTRLRecord itemRecord) {
	...
	public void setExcludeItemDelegate(
			ItemWriter<? super HkMtgWoRecvTRLRecord> excludeItemDelegate) {
