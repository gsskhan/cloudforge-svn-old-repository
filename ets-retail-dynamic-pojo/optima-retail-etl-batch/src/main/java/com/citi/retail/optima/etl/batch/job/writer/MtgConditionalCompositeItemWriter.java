...
public class MtgConditionalCompositeItemWriter extends
		CompositeItemWriter<MortgageTRLRecord> implements StepExecutionListener {

	private ItemWriter<? super MortgageTRLRecord> excludeItemDelegate;

	private Long partitionWriteRecordCount = 0L;

	private StepExecution stepExecution;

	public void write(List<? extends MortgageTRLRecord> item) throws Exception {
		
		List<MortgageTRLRecord> includeList = new ArrayList<MortgageTRLRecord>();

		for (MortgageTRLRecord itemRecord : item) {
			if(itemRecord != null){
	...
	private void saveCBResult(MortgageTRLRecord itemRecord) {
	...
	public void setExcludeItemDelegate(
			ItemWriter<? super MortgageTRLRecord> excludeItemDelegate) {
