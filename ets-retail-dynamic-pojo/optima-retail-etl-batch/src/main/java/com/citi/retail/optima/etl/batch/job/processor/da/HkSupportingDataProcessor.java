 ...
 * 
 */
public class HkSupportingDataProcessor<T> implements ItemProcessor<T, T>,InitializingBean, ItemReadListener<T> {
	...
	private static final Logger LOGGER = LoggerFactory
            ...
            .getLogger(HkSupportingDataProcessor.class);
	
	@Override
	public T process(T currentEvent) throws Exception {
		preProcessdMap.put(((HkRcBaseRecord)currentEvent).getAcNo(), currentEvent);
		return currentEvent;
	}
