...
import com.citi.retail.optima.etl.cache.resultset.setter.SourceRegionSetExtractor;
 ...
 * 
 */
public class SourceRegionDaoImpl implements CacheLoaderDao<SourceRegionDomain>,
		InitializingBean {

	private final Logger LOGGER = (Logger) LoggerFactory
			.getLogger(SourceRegionDaoImpl.class);
	private JdbcTemplate jdbcTemplate;
	private List<SourceRegionDomain> srcRegionRefList;

	private String sql;

	public List<SourceRegionDomain> getCacheData()
			throws OptimaRetailApplicationException {

		srcRegionRefList = new ArrayList<SourceRegionDomain>();
		try {
			srcRegionRefList = jdbcTemplate.query(sql,
					new SourceRegionSetExtractor());
		...
		return srcRegionRefList;
	}

	@Override
	public List<SourceRegionDomain> getCacheData(Object... args)
			throws Exception {
		return srcRegionRefList;
	}
