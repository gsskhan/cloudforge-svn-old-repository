...
import com.citi.retail.optima.etl.cache.dao.impl.CollateralisedMappingDaoImpl;
 ...
 *
 */
public class CollateralisedMappingCacheLoaderImpl extends OptimaCacheDataLoader {

	private SingleValueCacheEntryHelper<String, Integer> cacheEntryHelper;
	private CollateralisedMappingDaoImpl dao;

	public void setDao(CollateralisedMappingDaoImpl dao) {
		this.dao = dao;
	}
